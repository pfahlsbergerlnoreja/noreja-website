...
const teamMembersBase: TeamMemberBase[] = [
  ...
  },
  {
    ...
    oneLiner: "Turning process and data insights into measurable improvement.",
    linkedInUrl: "https://www.linkedin.com/in/monikaleitner/",
    imageFilename: "Monika-Leitner.webp",
    isFounder: false,
    personalIntro: {
      en: "Monika is a process and data enthusiast with more than 20 years of experience in Process Mining, Process Management, Process Automation, Integration, Business Intelligence, and Data Warehousing. Throughout her career, she has worked at the intersection of technology and business, helping organizations understand how their processes really run and how data can be used to drive meaningful, measurable improvement.\n\nIn her previous role as Senior Director at Software AG, she focused on building and evolving Process Mining competencies, enabling go-to-market initiatives, supporting partners, and shaping value-driven demos and solution approaches — bringing together Process Mining, analytics, and enterprise architecture to help customers move from insights to action. With extensive experience in pre-sales, customer success, and competence center leadership, she enjoys coaching teams, enabling partners, and fostering knowledge exchange within the Process Mining community. For Monika, successful transformation is not about tools alone, but about people, collaboration, and making technology usable in everyday business.",
      de: "Monika ist eine Prozess- und Datenenthusiastin mit über 20 Jahren Erfahrung in Process Mining, Prozessmanagement, Prozessautomatisierung, Integration, Business Intelligence und Data Warehousing. In ihrer Laufbahn arbeitete sie stets an der Schnittstelle von Technologie und Business und half Organisationen dabei, zu verstehen, wie ihre Prozesse tatsächlich ablaufen und wie sich Daten für spürbare, messbare Verbesserungen nutzen lassen.\n\nIn ihrer letzten Rolle als Senior Director bei der Software AG konzentrierte sie sich auf den Auf- und Ausbau von Process-Mining-Kompetenzen, die Unterstützung von Go-to-Market-Initiativen und Partnern sowie die Gestaltung wertorientierter Demos und Lösungsansätze – und verbindet dabei Process Mining, Analytics und Enterprise Architecture, um Kunden von Erkenntnissen zu konkretem Handeln zu führen. Mit umfangreicher Erfahrung in Pre-Sales, Customer Success und der Leitung von Competence Centern coacht sie mit Begeisterung Teams, befähigt Partner und fördert den Wissensaustausch in der Process-Mining-Community. Für Monika gelingt Transformation nicht durch Tools allein, sondern durch Menschen, Zusammenarbeit und Technologie, die im Arbeitsalltag wirklich nutzbar ist."
    }
  }
];
