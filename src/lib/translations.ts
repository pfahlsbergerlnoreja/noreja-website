    ...
    pages: {
      ...
      partners: {
        ...
        partnerDescriptions: {
          ...
          "22": "MINAUTICS GmbH is a full-service BPM consultancy in the German-speaking region that combines cross-industry experience with specialized expertise in business process management and technical process automation. Drawing on deep methodological and technological know-how, MINAUTICS delivers demonstrably effective process improvements for its clients — from training, consulting, and staffing to the execution of complete BPM implementation projects. This is how MINAUTICS makes companies more successful and their customers more satisfied."
        },
        partnerCategories: {
    ...
    pages: {
      ...
      partners: {
        ...
        partnerDescriptions: {
          ...
          "22": "Die MINAUTICS GmbH ist eine Full-Service-BPM-Beratung im deutschsprachigen Raum, die branchenübergreifende Erfahrung mit spezialisierter Expertise im fachlichen Prozessmanagement und in der technischen Prozessautomatisierung verbindet. Mit fundiertem Methoden- und Technologie-Know-how setzt MINAUTICS nachweisbar wirksame Prozessverbesserungen bei ihren Kunden um – von Schulungen über Beratung und Personalbereitstellung bis hin zur Durchführung kompletter BPM-Implementierungsprojekte. So macht MINAUTICS Unternehmen erfolgreicher und deren Kunden zufriedener."
        },
        partnerCategories: {
